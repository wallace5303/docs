...
###  安装
准备：需要python环境 ([macos安装Python](/docs/blog/macos/install-python))
```bash
...
- [Mac显示资源库Library](/docs/blog/macos/show-library)

### 更多语法
###  Storage对象API文档
[Storage文档](/docs/v2/api/storage)

### better-sqlite3
[better-sqlite3 文档](https://github.com/WiseLibs/better-sqlite3/blob/HEAD/docs/api.md#class-database)
