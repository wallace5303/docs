...
**See also**：[UpdaterConfig](/09.api/002.ee-bin/020.config-types)

### ohos

Extract build artifacts to HarmonyOS HAP resource directories.
...
**See also**：[OhosConfig](/09.api/002.ee-bin/020.config-types)
