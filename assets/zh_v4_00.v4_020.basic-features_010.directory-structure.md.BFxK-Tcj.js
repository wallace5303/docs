import{_ as n,o as a,c as p,a3 as e}from"./chunks/framework.B5WAEDB7.js";const x=JSON.parse('{"title":"目录结构","description":"","frontmatter":{"title":"目录结构"},"headers":[],"relativePath":"zh/v4/00.v4/020.basic-features/010.directory-structure.md","filePath":"zh/v4/00.v4/020.basic-features/010.directory-structure.md","lastUpdated":1786611987000}'),l={name:"zh/v4/00.v4/020.basic-features/010.directory-structure.md"};function i(c,s,t,o,r,d){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h3 id="目录结构及说明" tabindex="-1">目录结构及说明 <a class="header-anchor" href="#目录结构及说明" aria-label="Permalink to &quot;目录结构及说明&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>project</span></span>
...
<span class="line"><span>    ├── sqlite-demo.db 示例sqlite数据库</span></span></code></pre></div>`,2)])])}const m=n(l,[["render",i]]);export{x as __pageData,m as default};
